...
import liujianze.pojo.User;
import liujianze.pojo.query.UserQuery;
import liujianze.service.UserService;
...
public class UserController {
   ...
   public String toUpdate(Model model){
    ...
    @GetMapping("/back")
    public String toback(Model model,UserQuery userQuery){
        PageInfo<User> userPageInfo = userService.listUserByName(userQuery);
        model.addAttribute("page",userPageInfo);
        return "login";
    }
